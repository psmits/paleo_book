...
The `pacman` package is used throughout to ensure that all packages are both installed and loaded into namespace.


<!--chapter:end:index.Rmd-->

# Managing and Processing Paleobiology Database data
...
```{r load_packages_01, results = 'hide'}
...
```{r load_packages_02, results = 'hide'}
...
<!--chapter:end:02-intro_bayes.Rmd-->
...
```{r load_packages_03, message = F, results = 'hide'}
...
<!--chapter:end:03-intro_regression.Rmd-->
...
```{r load_packages_04, message = F, results = 'hide'}
...
<!--chapter:end:04-regression_continue.Rmd-->
...
<!--chapter:end:05-regression_multi.Rmd-->
