...
We can also visualize the relationship between the individual covariates and coiling state.
...
How can we measure our model's adequacy?
...
Our model appears to correctly guess the coiling state of any observation about 62-63% of the time. Would you be confident in a model that is only this accurate? How might we improve upon this model?
